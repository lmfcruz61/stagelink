...
3. Abrir `/admin/` e verificar Users, Artists, Organizations, Organization Members, Espetáculos, Subscriptions, Tips e Site Appearance.
...
7. Abrir uma sala de espetáculo como admin. O admin deve entrar sem bilhete nem subscricao.
