...
7. Abrir uma sala de evento como admin. O admin deve entrar sem bilhete nem subscricao.
...
7. Tentar entrar num evento pago sem acesso. Deve aparecer bloqueio.
8. Comprar bilhete em modo teste ou criar acesso/subscricao de teste.
9. Entrar na sala.
10. Se o evento ainda estiver no futuro, confirmar o estado `Agendado` e a contagem decrescente.
...
9. Confirmar que o contador `a ver` aparece junto ao titulo do evento e no cabecalho do chat.
...
6. Admin conseguir entrar em qualquer evento.
...
Empresa/manager cria artista, artista tem pagina publica, evento com tipo correto e acesso pago; publico entra, ve countdown/player com marca do artista, conversa no chat, usa emojis, ve a contagem de espectadores e envia gorjeta; admin consegue supervisionar tudo.
